...
- **Architecture diagrams** — use the `architecture` skill (which routes to `drawio-architecture`, `mermaid-architecture`, and optional `archify`) for visual and Markdown system design.
